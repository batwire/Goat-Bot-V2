...
module.exports = {
  ...
  onStart: async function ({ api, event, message }) {
    try {
      ...
      const loadingMessage = await api.sendMessage("Searching Random Editing Audio..", event.threadID, null, event.messageID);

      const apiKey = "AIzaSyAO1tuGus4-S8RJID51f8WJAM7LXz1tVNc";
      const playlistId = "PLExSsQgUCIkEbPfHqqkRO5KPvTxZzIupZ&si";
